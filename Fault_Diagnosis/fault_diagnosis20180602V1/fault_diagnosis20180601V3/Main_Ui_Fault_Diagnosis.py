...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def decode(self, num):
        ...
        self.labelEdit_DSP_X.setText(str(coordinate_x(num)))
        ...
        self.labelEdit_DSP_Y.setText(str(coordinate_y(num)))
        ...
        self.labelEdit_DSP_H.setText(str(coordinate_heading(num)))
        ...
        # ==========================================
        # 功能：将AGV的托盘角度在UI上显示
        self.labelEdit_PodaAngle.setText(str(PodAngle(num)))
        ...
        print(str( Right_CMD_Speed_Analysis(num)))
        
        # ==========================================
        
        # ==========================================
        # 功能：将小车速度数据在UI上显示
        self.labelEdit_AgvSpeed.setText(str(AGV_Real_Speed(num)))
